...
function P(a, b, c, e, d) {
  ...
  if (G(a)) for (var g = 0; g < a.length; g++) {
    ...
    var f = e + O(l, g);
    h += P(l, b, c, f, d);
  } else if (f = y(a), "function" === typeof f) for (a = f.call(a), g = 0; !(l = a.next()).done;) {
    l = l.value, f = e + O(l, g++), h += P(l, b, c, f, d);
  } else if ("object" === l) throw b = String(a), Error(z(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
