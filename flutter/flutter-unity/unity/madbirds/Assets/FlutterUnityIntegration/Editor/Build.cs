...
#unity-mobile-warning { position: absolute; left: 50%; top: 5%; transform: translate(-50%); background: white; padding: 10px; display: none }
        ...
        private static void ModifyAndroidGradle(bool isPlugin)
        {
            ...
            // buildText = Regex.Replace(buildText, @"commandLineArgs.add\(\"--enable-debugger\"\)", "\n");
            // buildText = Regex.Replace(buildText, @"commandLineArgs.add\(\"--profiler-report\"\)", "\n");
            // buildText = Regex.Replace(buildText, @"commandLineArgs.add\(\"--profiler-output-file=\" + workingDir + \"/build/il2cpp_\"+ abi + \"_\" + configuration + \"/il2cpp_conv.traceevents\"\)", "\n");
